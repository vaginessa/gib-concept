...
class InstalledFragment : Fragment(), NavFragment {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val view = inflater.inflate(R.layout.bottomtab_installed_fragment, container, false)
    ...
    companion object {
        ...
        fun newInstance() = InstalledFragment()
    }
}